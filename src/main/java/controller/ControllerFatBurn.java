...
public class ControllerFatBurn implements Initializable {
    ...
    public int aux=0;
    public void newExercise(ActionEvent event) throws  Exception {
        if(Controller.ok==0) {
    ...
    public ObservableList<Exercise>  getEx() {
       ObservableList<Exercise> data = FXCollections.observableArrayList();
        ...
        System.out.println(ControllerMenuTrainer.ct);
        if(ControllerMenuTrainer.ct==1){
